[tml-multi-agenticai-iot-3f10-agenticai-0fd4] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [tml-multi-agenticai-iot-3f10-agenticai-0fd4] container is NOT running**.

.. tip::
   You must have your [tml-multi-agenticai-iot-3f10-agenticai-0fd4] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/Rekhamei/raspberrypitss/blob/main/tml-airflow/logs/logs.txt
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  -v /your_localmachine/foldername:/rawdata:z  \-\-env GITREPOURL=https://github.com/Rekhamei/raspberrypitss  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=33545  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='Rekhamei'  \-\-env DOCKERUSERNAME='rekhamei'  \-\-env MQTTUSERNAME=''  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  \-\-env UPDATE=1  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:9005/dashboard.html?topic=&offset=-1&groupid=&rollbackoffset=100&topictype=prediction&append=0&secure=1
...
[tml-multi-agenticai-iot-3f10-agenticai-0fd4] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/Rekhamei/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10
...
.. important::
   solution_preprocessing_agenticai_dag-tml-multi-agenticai-iot-3f10
...
.. important::
   VIPERHOST_PRODUCE=172.17.0.2, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=172.17.0.2, VIPERPORT_PREPROCESS=34901, VIPERHOST_PREPOCESS2=172.17.0.2, VIPERPORT_PREPROCESS2=38661, VIPERHOST_PREPOCESS_PGPT=172.17.0.2, VIPERPORT_PREPROCESS_PGPT=46603, VIPERHOST_ML=172.17.0.2, VIPERPORT_ML=34433, VIPERHOST_PREDCT=172.17.0.2, VIPERPORT_PREDICT=42169, HPDEHOST=172.17.0.2, HPDEPORT=37719, HPDEHOST_PREDICT=172.17.0.2, HPDEPORT_PREDICT=45455

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-403-tml-multi-agenticai-iot-3f10-agenticai-0fd4,solution_preprocessing_agenticai_dag-tml-multi-agenticai-iot-3f10, python-preprocess-9979-tml-multi-agenticai-iot-3f10-agenticai-0fd4,solution_preprocessing_agenticai_dag-tml-multi-agenticai-iot-3f10, python-agenticai-2611-tml-multi-agenticai-iot-3f10-agenticai-0fd4,solution_preprocessing_agenticai_dag-tml-multi-agenticai-iot-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
